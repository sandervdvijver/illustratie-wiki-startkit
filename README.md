...
- de [random-rotatie pagina](https://raw.githack.com/sandervdvijver/illustratie-wiki-startkit/main/voorbeelden/random-rotatie.html) toont hoe je met CSS en JS je elementen (wellicht afbeeldingen) zich iets meer als voorwerpen met een rotatie en gewicht kan laten gedragen. Handig als je spullen afbeeldt.
- het [horizontal-slideshow](https://raw.githack.com/sandervdvijver/illustratie-wiki-startkit/main/voorbeelden/horizontal-slide.html) voorbeeld toont hoe je met _Swiper_ makkelijk verschillende beelden in een loopende horizontale slideshow kan zetten (die je ook kan bedienen met klikken, swipen en de pijltjestoetsen)
- het [grid voorbeeld](https://raw.githack.com/sandervdvijver/illustratie-wiki-startkit/main/voorbeelden/grid.html) voorbeeld toont enkele manieren om met grid te werken.
